...
export default function DashboardPage() {
  ...
  useEffect(() => {
    // For demo purposes, redirect to tenant-admin dashboard
    // Change this to test different dashboards:
    // - /superadmin (for super admin)
    // - /tenant-admin (for business admin)
    // - /user (for regular user)
    router.push("/tenant-admin")
  }, [router])

  return (
    <div className="min-h-screen bg-gradient-to-br from-glass-50 via-glass-100 to-glass-200 flex items-center justify-center">
      <div className="text-center animate-fade-in">
        <div className="w-16 h-16 bg-gradient-to-r from-soft-blue to-soft-purple rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-xl">
          <div className="w-8 h-8 border-4 border-white border-t-transparent rounded-full animate-spin"></div>
        </div>
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Loading Dashboard...</h1>
        <p className="text-gray-600">Taking you to your business interface</p>
      </div>
    </div>
  )
}
